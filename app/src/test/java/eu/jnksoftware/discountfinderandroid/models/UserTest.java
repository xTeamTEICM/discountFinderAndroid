...
public class UserTest {
    ...
    public void getID() throws Exception {
        User testUser= new User(1,"makis","kovanidis","makis_kovanidis@hotmail.com", "pass","pass", Role.CUSTOMER,new Date(),new Date(),"aaaaaaaa");
    ...
    public void getCreationDate() throws Exception {
        User testUser= new User(1,"makis","kovanidis","makis_kovanidis@hotmail.com", "pass","pass", Role.CUSTOMER,new Date(2017,5,20),new Date(),"aaaaaaaa");
    ...
    public void getLastLogin() throws Exception {
        User testUser= new User(1,"makis","kovanidis","makis_kovanidis@hotmail.com", "pass","pass", Role.CUSTOMER,new Date(),new Date(2017,5,20),"aaaaaaaa");
    ...
    public void saveTest() throws Exception{
        User testUser= new User(1,"makis","kovanidis","makis_kovanidis@hotmail", "pass","pass", Role.CUSTOMER,new Date(),new Date(),"aaaaaaaa");
