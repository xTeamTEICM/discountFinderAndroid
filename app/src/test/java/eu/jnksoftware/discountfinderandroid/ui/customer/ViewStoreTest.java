...
public class ViewStoreTest {
    ...
    public void setUp() throws Exception {
        mockCallDiscounts.add(new SellerDiscount(1,1,30.0
                        ,25.0,"ds","dsds"));
        mockCallDiscounts.add(new SellerDiscount(2,2,54.0,36.0,"ds","dsa"));
        mockCallDiscounts.add(new SellerDiscount(3,1,104.4,32.5,"a","b"));
    }
